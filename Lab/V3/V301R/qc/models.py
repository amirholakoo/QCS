...
class QCRecord(models.Model):
    ...
    # Edit lock (only one user can edit at a time)
    editing_by = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name='qc_edit_locks',
        verbose_name='کاربر در حال ویرایش'
    )
    editing_started_at = models.DateTimeField(null=True, blank=True, verbose_name='زمان شروع ویرایش')
    edit_lock_expires_at = models.DateTimeField(null=True, blank=True, verbose_name='زمان انقضای قفل ویرایش')
    ...
    # Timestamps
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='زمان ایجاد',blank=True,null=True)
    ...
    #last_update = models.DateTimeField( verbose_name='آخرین بروزرسانی')
    is_delete = models.BooleanField(default=False, verbose_name='حذف نمایشی')
