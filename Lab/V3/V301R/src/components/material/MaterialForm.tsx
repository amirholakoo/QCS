...
import { useDeleteMaterial, usePermissions } from '../../hooks/useAPI';
...
export const MaterialForm: React.FC<MaterialFormProps> = ({ material, onSave, onCancel, onDelete, readOnly = false }) => {
  ...
  const materialPerms = permissionsData?.permissions?.material || { view: false, add: false, change: false, delete: false };
          ...
          {!readOnly && (
            <div className="flex justify-end pt-6 border-t border-gray-200">
              <div className="flex gap-4">
                ...
                {isEditing && materialPerms.delete && (
                  <button 
                    type="button" 
                ...
                {((isEditing && materialPerms.change) || (!isEditing && materialPerms.add)) && (
