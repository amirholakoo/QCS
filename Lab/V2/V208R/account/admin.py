...
class SystemSettingsAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['version', 'is_updating', 'updating_timer_seconds']
    fieldsets = (
        (None, {'fields': ('version', 'update_details')}),
        ('وضعیت به‌روزرسانی', {
            'fields': ('is_updating', 'updating_timer_seconds', 'updating_message'),
            'description': 'وقتی «در حال به‌روزرسانی» فعال است، همه کاربران فقط صفحه به‌روزرسانی را می‌بینند تا آن را غیرفعال کنید.',
        }),
    )
