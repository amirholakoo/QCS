...
import { LogOut, User, FileText, Layers, Package, Activity, BarChart3, CheckCircle, Settings, Menu, X, ChevronDown, FileType } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  const navItems: { key: AppSection; label: string; icon: React.ReactNode }[] = [
    ...
    { key: 'paper-type', label: 'انواع کاغذ', icon: <FileType className="w-5 h-5" /> },
