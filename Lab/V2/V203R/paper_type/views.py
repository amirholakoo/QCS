...
class PaperTypeViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        if self.request.user.is_authenticated:
            try:
                log_action(self.request.user.username, 'PaperType', 'create')
            except:
                pass
    ...
    def perform_update(self, serializer):
        ...
        if self.request.user.is_authenticated:
            try:
                log_action(self.request.user.username, 'PaperType', 'edit')
            except:
                pass
    ...
    def perform_destroy(self, instance):
        ...
        if self.request.user.is_authenticated:
            try:
                log_action(self.request.user.username, 'PaperType', 'delete')
            except:
                pass
