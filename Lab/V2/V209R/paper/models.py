...
class Paper(models.Model):
    ...
    warehouse = models.CharField(max_length=200, blank=True, null=True, verbose_name='انبار')
    ...
    profile_details = models.JSONField(blank=True, null=True, verbose_name='جزئیات پروفایل')
    ...
    # Resistance tests
    burst_test = models.TextField(blank=True,null=True, verbose_name='Burst')
...
class PM_Setting(models.Model):
    ...
    cylinder_temperature_before_press = models.FloatField(blank=True, null=True, verbose_name='دمای اصلی خشک کن یک و دو')
    cylinder_temperature_after_press = models.FloatField(blank=True, null=True, verbose_name='دمای اصلی خشک کن سه')
    paper_temperature_before_starch = models.FloatField(blank=True, null=True, verbose_name='دمای کاغذ قبل از ورود به سایز پرس')
    fructose_temperature_before_press = models.FloatField(blank=True, null=True, verbose_name='دمای نشاسته قبل از ورودی سایز پرس')
    paper_temperature_before_dryer3 = models.FloatField(blank=True, null=True, verbose_name='دمای کاغذ قبل از ورود به خشک کن سه')
    dryer3_first_cylinder_temperature = models.FloatField(blank=True, null=True, verbose_name='دمای سیلندر اول خشک کن سه')
