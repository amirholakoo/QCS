...
class QCRecord(models.Model):
    ...
    def get_custom_fields_display(self):
        ...
        field_mapping = {
            ...
            'cylinder_temperature_before_press': 'دمای سیلندر قبل از سایز پرس',
            'cylinder_temperature_after_press': 'دمای سیلندر بعد از سایز پرس',
            'cct1': 'CCT 1',
            'cct2': 'CCT 2',
            'cct3': 'CCT 3',
            'cct4': 'CCT 4',
                ...
                if is_combined:
                    ...
                    if self.loading_id.custom:
                        ...
                        if field_name in loading_field_mapping:
                            ...
                            # Keep real data for fields that don't have loading equivalents
