              ...
              <table className="table">
                <thead className="sticky top-0 z-10 bg-gray-50">
                  <tr>
                    ...
                    <th className="bg-gray-50">مسئول</th>
                    ...
                    <th className="bg-gray-50">غلظت</th>
                    <th className="bg-gray-50">رقیق‌ساز</th>
                    ...
                    <th className="bg-gray-50"> پارگی ( تعداد - زمان )</th>
                    <th className="bg-gray-50">کالندر</th>
                    <th className="bg-gray-50">سرعت ماشین</th>
