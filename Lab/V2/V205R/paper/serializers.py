...
class PaperSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        # print(validated_data["ash_percentage"],"after")
        # #getattr(instance, field.name)
        # print(instance,"before",getattr(instance, 'ash_percentage'))
        ...
        for key,value in validated_data.items():
            if not getattr(instance, key) == value:
                ...
                details.append({"name":key,"old": old ,"new":value,"roll_number":getattr(instance, "roll_number")})
