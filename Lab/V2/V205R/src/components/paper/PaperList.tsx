              ...
              <table className="table">
                <thead className="sticky top-0 z-10 bg-gray-50">
                  <tr>
                    ...
                    <th className="bg-gray-50 table-gradient-divider">مواد</th>
                          ...
                          <div style={{maxWidth: '150px', textWrap: 'wrap', minWidth: '120px'}} className="text-xs">
                            {pmSettings.map((setting, idx) => (
                              <div key={setting.id || idx} className="mb-2 pb-2 border-b border-gray-200 last:border-0">
                                <span className="inline-flex items-center px-2 py-0.5 mb-1 rounded-full text-[11px] font-bold bg-primary-50 text-primary-700">
                                  {setting.production_machine_title || `ماشین ${idx + 1}`}
                                </span>
                                {(setting.bottom || setting.top) && (
                                  <div className="mt-0.5 space-y-0.5">
                                    <div className="text-[11px] font-semibold bg-gray-200 rounded p-1">فشار هدباکس</div>
                                ...
                                {(setting.cylinder_temperature_before_press != null ||
                                  ...
                                  <div className="mt-0.5 space-y-0.5">
                                    <div className="text-[11px] font-semibold bg-gray-200 rounded p-1">دما سیلندر</div>
                                    <div className="flex justify-between">
                                ...
                                {(setting.paper_temperature_before_starch != null ||
                                  ...
                                  <div className="mt-0.5 space-y-0.5">
                                    <div className="text-[11px] font-semibold bg-gray-200 rounded p-1">دما کاغذ</div>
                                    <div className="flex justify-between">
