...
import { TrendingUp, TrendingDown, Loader2, Calendar, CalendarDays, CalendarRange, Database, BarChart3, Activity, FileText, Droplets, Layers, Beaker } from 'lucide-react';
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-50 to-green-50/50 rounded-lg border border-emerald-100/50">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-gray-600">بالاترین</span>
            </div>
          ...
          <div className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-indigo-50/50 rounded-lg border border-blue-100/50">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-gray-600">پایین‌ترین</span>
            </div>
          ...
          {average !== null && (
            <div className="flex items-center justify-between px-3 py-2 bg-gray-50/50 rounded-lg">
              <span className="text-xs text-gray-500">میانگین</span>
    ...
    return (
      <div className="flex items-center justify-center min-h-[500px]">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium mt-6">در حال بارگذاری آمار...</p>
    ...
    return (
      <div className="min-h-[400px] flex items-center justify-center p-8">
        <div className="bg-white rounded-2xl shadow-xl border border-red-100 p-12 max-w-md text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">خطا در دریافت اطلاعات</h3>
    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="relative">
        ...
        <div className="relative">
          ...
          <p className="text-gray-500 text-sm sm:text-base md:text-lg mr-5">نمای کلی آمار تولید و تحلیل داده‌های کیفی</p>
        </div>
      </div>
      ...
      {periodData && (
        <div className="space-y-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-1">
                    آمار {activeTabConfig?.label}
                  </h3>
                  <p className="text-gray-400 text-sm">بالاترین و پایین‌ترین مقادیر ثبت شده</p>
                </div>
              </div>
              
              {/* Total Production - Prominent Display */}
              <div className="bg-white/10 backdrop-blur-md px-8 py-5 rounded-2xl border border-white/20 shadow-xl">
                <div className="flex items-center gap-4">
                  <BarChart3 className="w-8 h-8 text-white/80" />
                  <div>
                    <p className="text-xs text-gray-300 mb-1">تولید کل</p>
                    <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-black text-white">
                        {formatPersianDate(periodData.total_production.toString())}
                      </span>
                      <span className="text-xs text-gray-400">رکورد</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <StatsSection title="آمار کلی" color="blue" icon={<FileText className="w-5 h-5" />}>
            <MetricCard
              label="گراماژ"
          ...
          <StatsSection title="آمار توری پایین" color="green" icon={<Droplets className="w-5 h-5" />}>
            <MetricCard
              label="کانس خمیر پایین"
              highest={periodData.downpulpcount?.highest}
              lowest={periodData.downpulpcount?.lowest}
            />
            <MetricCard
              label="کانس توری پایین"
          ...
          <StatsSection title="آمار توری بالا" color="purple" icon={<Layers className="w-5 h-5" />}>
            <MetricCard
              label="کانس خمیر بالا"
              highest={periodData.upper_headbox_consistency?.highest}
              lowest={periodData.upper_headbox_consistency?.lowest}
            />
            <MetricCard
              label="کانس توری بالا"
          ...
          <StatsSection title="آمار خمیر حوضها" color="orange" icon={<Beaker className="w-5 h-5" />}>
            <MetricCard
              label="حوض 8"
