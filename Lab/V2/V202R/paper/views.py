...
class PaperViewSet(viewsets.ModelViewSet):
    ...
    def export_xlsx(self, request):
        ...
        for row_num, paper in enumerate(queryset, 2):
            ...
            ws.cell(row=row_num, column=8, value=paper_type_map.get(paper.paper_type, '') if paper.paper_type else '')
            ...
            ws.cell(row=row_num, column=18, value=paper.cylinder_temperature_before_press or '')
            ws.cell(row=row_num, column=19, value=paper.cylinder_temperature_after_press or '')
