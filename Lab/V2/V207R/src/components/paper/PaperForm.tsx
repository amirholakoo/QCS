...
import { useMaterials, usePaperSuggestions, useDeletePaper, useProductionMachines, usePaperTypes } from '../../hooks/useAPI';
...
export const PaperForm: React.FC<PaperFormProps> = ({ paper, onSave, onCancel, onDelete, readOnly = false }) => {
  ...
  useEffect(() => {
    const fetchLastRollNumber = async () => {
      try {
        const response = await paperAPI.list({ sort_by: '-roll_number', page_size: '1' });
  ...
  useEffect(() => {
    if (paper) {
      ...
      const pmSettingsMap: {[machineId: string]: {bottom: string, top: string, cylinder_temperature_before_press?: number, cylinder_temperature_after_press?: number, paper_temperature_before_starch?: number, paper_temperature_before_pop_reel?: number}} = {};
      ...
      const emptySettings: {[machineId: string]: {bottom: string, top: string, cylinder_temperature_before_press?: number, cylinder_temperature_after_press?: number, paper_temperature_before_starch?: number, paper_temperature_before_pop_reel?: number}} = {};
      if (Array.isArray(productionMachines)) {
        productionMachines.forEach((machine: ProductionMachine) => {
  ...
  const handlePMSettingChange = (machineId: string, field: 'bottom' | 'top' | 'cylinder_temperature_before_press' | 'cylinder_temperature_after_press' | 'paper_temperature_before_starch' | 'paper_temperature_before_pop_reel', value: string | number | undefined) => {
    setPmSettings(prev => ({
      ...prev,
      [machineId]: {
                    ...
                    return (
                      <div key={machine.id} className={`p-4 rounded-lg border-2 ${bgColor} ${borderColor}`}>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                          <div className="form-group">
                            <label className="form-label">شیر خمیر هدباکس پایین</label>
                            <input
                              type="text"
                          ...
                          <div className="form-group">
                            <label className="form-label">شیر خمیر هدباکس بالا</label>
                            <input
                              type="text"
                              value={setting.top}
                          ...
                          <div className="form-group">
                            <label className="form-label">دمای سیلندر قبل از سایز پرس</label>
                            <input
                              type="text"
                              ...
                              className="form-input"
                              placeholder="قبل از سایز پرس"
                              disabled={readOnly}
                            />
                          </div>
                          
                          <div className="form-group">
                            <label className="form-label">دمای سیلندر بعد از سایز پرس</label>
                            <input
                              type="text"
                              ...
                              className="form-input"
                              placeholder="بعد از سایز پرس"
                              disabled={readOnly}
                            />
                          </div>
                          
                          <div className="form-group">
                            <label className="form-label">دمای کاغذ قبل از نشاسته</label>
                            <input
                              type="text"
                              ...
                              onChange={(e) => {
                                const value = e.target.value;
                                if (value === '') {
                                  handlePMSettingChange(machine.id, 'paper_temperature_before_starch', undefined);
                                } else {
                                  const numValue = parseFloat(value);
                                  if (isNaN(numValue)) {
                                    handlePMSettingChange(machine.id, 'paper_temperature_before_starch', undefined);
                                  } else {
                                    handlePMSettingChange(machine.id, 'paper_temperature_before_starch', numValue);
                                  }
                                }
                              }}
                              className="form-input"
                              placeholder="قبل از نشاسته"
                              disabled={readOnly}
                            />
                          </div>
                          
                          <div className="form-group">
                            <label className="form-label">دمای کاغذ قبل از پوپ ریل</label>
                            <input
                              type="text"
                              ...
                              onChange={(e) => {
                                const value = e.target.value;
                                if (value === '') {
                                  handlePMSettingChange(machine.id, 'paper_temperature_before_pop_reel', undefined);
                                } else {
                                  const numValue = parseFloat(value);
                                  if (isNaN(numValue)) {
                                    handlePMSettingChange(machine.id, 'paper_temperature_before_pop_reel', undefined);
                                  } else {
                                    handlePMSettingChange(machine.id, 'paper_temperature_before_pop_reel', numValue);
                                  }
                                }
                              }}
                              className="form-input"
