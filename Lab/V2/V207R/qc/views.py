...
class CustomerViewSet(viewsets.ModelViewSet):
    ...
    def perform_destroy(self, instance):
        """
        Delete customer and log the action.
        """
        from logs.utils import log_action
        
        customer_name = instance.name_family
        instance.delete()
        ...
        if self.request.user.is_authenticated:
            try:
                ...
                log_action(self.request.user.username, 'Customer', 'delete', details)
            except:
                pass
...
class LoadingViewSet(viewsets.ModelViewSet):
    ...
    def perform_destroy(self, instance):
        """
        Delete loading and log the action.
        """
        from logs.utils import log_action
        
        loading_id = instance.id
        instance.delete()
        ...
        if self.request.user.is_authenticated:
            try:
                details = [{
                    "name": "مشخصات بارگیری",
                    "old": f"Loading-{loading_id}",
                    "roll_number": None
                }]
                log_action(self.request.user.username, 'Loading', 'delete', details)
            except:
                pass
...
class QCRecordViewSet(viewsets.ModelViewSet):
    ...
    def perform_destroy(self, instance):
        """
        Delete QC record and log the action.
        """
        from logs.utils import log_action
        ...
        if self.request.user.is_authenticated:
            try:
                ...
                log_action(self.request.user.username, 'QCRecord', 'delete', details)
            except:
                pass
