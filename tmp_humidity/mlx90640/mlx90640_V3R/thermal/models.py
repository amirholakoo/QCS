...
class ProbeConfiguration(models.Model):
    ...
    checked_probes = models.JSONField(default=list)
    humidity_threshold = models.FloatField(default=7)
    roll_number = models.IntegerField(null=True, blank=True, default=3830)
    roll_Duration = models.IntegerField(null=True, blank=True, default=40 * 60)
    roll_remainder = models.IntegerField(null=True, blank=True, default=0)
    is_user_allowed_auto_change_roll_number = models.BooleanField(default=False)
    edge_threshold = models.FloatField(default=5)
    auto_edge_detection = models.BooleanField(default=True)
    class Meta:
        ordering = ['-updated_at']
