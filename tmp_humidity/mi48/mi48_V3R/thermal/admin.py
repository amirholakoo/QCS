...
class ProbeConfigurationAdmin(admin.ModelAdmin):
    list_display = ['updated_at_jalali', 'probe_count', 'active_formula_short', 'roll_number', 'roll_remainder', 'humidity_threshold','edge_threshold','roll_Duration','is_user_allowed_auto_change_roll_number']
    ...
    fieldsets = (
        (None, {
            'fields': ('created_at', 'created_at_jalali', 'updated_at', 'updated_at_jalali', 'active_formula', 'roll_number', 'roll_remainder', 'humidity_threshold','edge_threshold','roll_Duration','is_user_allowed_auto_change_roll_number')
        }),
        ('Probe Configuration', {
...
class ProbeDataAdmin(admin.ModelAdmin):
    list_display = ['timestamp_jalali', 'probe_count', 'temperature', 'humidity', 'active_formula_short', 'roll_number']
    ...
    fieldsets = (
        (None, {
            'fields': ('timestamp', 'timestamp_jalali', 'temperature', 'humidity', 'active_formula', 'roll_number')
        }),
        ('Probe Data', {
